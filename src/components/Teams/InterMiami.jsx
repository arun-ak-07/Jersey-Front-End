...
import TeamLogos from "../ShopByTeams/TeamLogos";
import { apiUrl } from "../../utils/api";

export default function InterMiami() {
  ...
  const getProducts = async () => {
    try {
      ...
      setShopByProducts(data.filter((data) => data.name.includes("Inter Miami")));
    } catch (error) {
      console.log(error);
    }
  };
    ...
    <div className="mainc">
      ...
      <div className="centerc5">
        <div className="imagec">
          <img
            src="https://dms.mydukaan.io/original/webp/media/314c437c-2b87-4935-89d9-07635b6712f5.blob"
            alt=""
          />
        </div>
