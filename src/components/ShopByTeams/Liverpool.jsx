...
export default function Liverpool() {
  ...
  const getProducts = async () => {
    try {
      ...
      setShopByProducts(data.filter((data) => data.name.includes("Liverpool")));
    } catch (error) {
      console.log(error);
    }
  };
    ...
    <div className="mainc">
      ...
      <div className="centerc5">
        <div className="imagec">
          <img
            src="https://dms.mydukaan.io/original/webp/media/a8b08d6a-2916-4793-bd1f-669767a47a7b.blob"
            alt=""
          />
        </div>
