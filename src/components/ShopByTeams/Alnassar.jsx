...
export default function Alnassar() {
  ...
  const getProducts = async () => {
    try {
      ...
      setShopByProducts(data.filter((data) => data.name.includes("Al Nassar")));
    } catch (error) {
      console.log(error);
    }
  };
    ...
    <div className="mainc">
      ...
      <div className="centerc5">
        <div className="imagec">
          <img
            src="https://dms.mydukaan.io/original/webp/media/fd83cd52-623a-4b7c-a070-98e7e03a6aad.blob"
            alt=""
          />
        </div>
